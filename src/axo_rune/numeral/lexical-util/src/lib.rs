...
//! [`alloc`], please look at [`core`] instead.
//!
//! <div class="warning">
//!
...
//! [`parse-float`]: https://crates.io/crates/lexical-parse-float
//! [`parse-integer`]: https://crates.io/crates/lexical-parse-integer
//! [`write-float`]: https://crates.io/crates/lexical-write-float
//! [`write-integer`]: https://crates.io/crates/lexical-write-integer
//! [`core`]: https://crates.io/crates/lexical-core
