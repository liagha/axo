...
impl TimeValue for u64 {
    ...
    fn saturating_mul(self, scalar: u32) -> Self {
        self.saturating_mul(scalar as u64)
    }
    fn saturating_div(self, scalar: u32) -> Self {
        self / (scalar as u64)
    }
...
impl TimeValue for u128 {
    ...
    fn saturating_mul(self, scalar: u32) -> Self {
        self.saturating_mul(scalar as u128)
    }
    fn saturating_div(self, scalar: u32) -> Self {
        self / (scalar as u128)
    }
    ...
    fn as_u32(self) -> u32 {
        self.min(u32::MAX as u128) as u32
    }
}
    ...
    pub fn to_microseconds(&self, time: T) -> T {
        ...
        if resolution_u32 >= 1_000_000 {
            ...
            time.saturating_mul(1_000_000)
                .saturating_div(scale_factor.max(1))
        } else {
            time.saturating_mul(1_000_000)
        }
    }
...
pub type DefaultTimer = PlatformTimer<u64, ArrayLapStorage<u64, 32>>;
...
impl DefaultTimer {
    pub fn new_default() -> Self {
        Timer::new(ArmGenericTimerSource::new(), ArrayLapStorage::new())
    }
}
...
impl DefaultTimer {
    pub fn new_default() -> Self {
        Timer::new(RiscvCycleSource::new(), ArrayLapStorage::new())
    }
}
...
impl DefaultTimer {
    pub fn new_default() -> Self {
        Timer::new(DummyTimeSource::new(), ArrayLapStorage::new())
    }
}
    ...
    L: LapStorage<T>,
{
    ...
    pub fn remaining(&self) -> TimerResult<T> {
        self.timer.remaining()?.ok_or(TimerError::InvalidDuration)
    }
