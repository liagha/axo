...
macro_rules! char_property {
    (
        ...
        impl $crate::text::EnumeratedCharProperty for $prop_name {
    ...
    (
        ...
        impl $prop_name {
            pub fn of(ch: char) -> Self {
                use $crate::text::tables::CharDataTable;
        ...
        impl $crate::text::TotalCharProperty for $prop_name {
            fn of(ch: char) -> Self { Self::of(ch) }
        }

        impl $crate::text::BinaryCharProperty for $prop_name {
    ...
    (
        ...
        impl $crate::text::CharProperty for $prop_name {
    ...
    (
        ...
        impl $crate::text::unicode::__str::FromStr for $prop_name {
            type Err = ();
    ...
    ( __impl Display for $prop_name:ident by $trait:ident ) => {
        impl $crate::text::unicode::__fmt::Display for $prop_name {
            fn fmt(&self, f: &mut $crate::text::unicode::__fmt::Formatter) -> $crate::text::unicode::__fmt::Result {
                $crate::text::$trait::human_name(self).fmt(f)
            }
        }
    };
}
